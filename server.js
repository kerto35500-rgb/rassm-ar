...
/* ══ صمّامُ الأمان الأخير ══
   خطأٌ غيرُ مُلتقَط في أيّ لعبةٍ كان يُسقط عمليّة Node كلَّها: تنقطع كلُّ
   الغرف في كلّ الألعاب دفعةً واحدة، ويُعاد التشغيل. سطرٌ واحدٌ في مؤقّت
   القنبلة يطرد من يلعبون بالوت في الطرف الآخر — وهذا ثمنٌ لا يُدفَع.
   نلتقط ونسجّل ونُكمل: لعبةٌ واحدةٌ تتعثّر خيرٌ من موقعٍ كلُّه يسقط.
   (الأخطاء تبقى ظاهرةً في السجلّ كي تُصلَّح، لا كي تُخفى.) */
process.on("uncaughtException", (e) => {
  console.error("💥 خطأٌ غيرُ مُلتقَط:", (e && e.stack) || e);
});
process.on("unhandledRejection", (e) => {
  console.error("💥 وعدٌ مرفوضٌ بلا معالج:", (e && e.stack) || e);
});
