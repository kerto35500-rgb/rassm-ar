...
const SCHEMA = {
  ...
  /* ── الجائزة اليوميّة والدوري ──
     الهديّة اليوميّة أرخصُ سببٍ لعودة اللاعب غدًا، والسلسلةُ تُضاعفها قليلًا
     كي تُكافئ الاستمرار لا الدخول العابر. أمّا جوائز الدوري فتُصرَف مرّةً
     واحدةً لكلّ أسبوع — يحرسها مفتاحُ منعِ التكرار في الدفتر. */
  league: {
    dailyOpen:     { def: true, type: "bool", name: "الجائزة اليوميّة مفعّلة" },
    dailyGold:     { def: 120, min: 0,  max: 5000,  name: "الجائزة اليوميّة" },
    dailyStreak:   { def: 30,  min: 0,  max: 2000,  name: "زيادةُ كلِّ يومٍ متتالٍ",
                     hint: "تُضاف عن كل يومٍ في السلسلة حتى الحدّ" },
    dailyMaxDays:  { def: 7,   min: 1,  max: 30,    name: "أقصى طول للسلسلة" },
    leagueOpen:    { def: true, type: "bool", name: "الدوري الأسبوعيّ مفعّل" },
    leagueWinPts:  { def: 3,   min: 0,  max: 100,   name: "نقاط الفوز في الدوري" },
    leaguePlayPts: { def: 1,   min: 0,  max: 100,   name: "نقاط المشاركة" },
    leaguePrize1:  { def: 5000, min: 0, max: 1000000, name: "جائزة المركز الأوّل" },
    leaguePrize2:  { def: 2500, min: 0, max: 1000000, name: "جائزة الثاني" },
    leaguePrize3:  { def: 1000, min: 0, max: 1000000, name: "جائزة الثالث" },
    leagueMinGames:{ def: 3,   min: 1,  max: 100,   name: "أقلّ عددِ مبارياتٍ للجائزة",
                     hint: "يمنع من لعب مباراةً واحدةً محظوظةً من أخذ الصدارة" }
  },

  /* ── التواصل داخل الطاولة ──
     الدردشة والهدايا أمتعُ ما في الطاولة وأخطرُ ما فيها. فالمفتاحان هنا كي
     يُطفَآ في لحظةٍ بلا نشرٍ جديد، والحدود كي لا يُغرِق أحدٌ الطاولة. */
  social: {
    chatOpen:     { def: true, type: "bool", name: "الدردشة مفتوحة" },
    giftsOpen:    { def: true, type: "bool", name: "الهدايا مفتوحة" },
    chatEveryMs:  { def: 1500,  min: 300, max: 20000, name: "أقلّ فاصلٍ بين رسالتين (مِلّي)" },
    giftEveryMs:  { def: 4000,  min: 500, max: 60000, name: "أقلّ فاصلٍ بين هديّتين (مِلّي)" },
    giftDailyCap: { def: 30000, min: 0,   max: 1000000, name: "سقف الإهداء اليوميّ",
                    hint: "مجموع ما يُنفَق على الهدايا في اليوم — صفرٌ يعني بلا سقف" }
  },
  site: {
